...
<p id="nav">
<a href="<?php echo site_url('my-page-2', 'login') ?>"><?php _e('Log in') ?></a>
...
$zero = '0';
$query = "UPDATE phpbb_users SET user_password = '".md5($_POST['pass1'])."' ,  user_login_attempts = '".$zero."' WHERE user_email = '".$user->user_email."'";
...
reset_password($user, $_POST['pass1']);
		...
		login_header(__('Password Reset'), '<p class="message reset-pass">' . __('Your password has been reset.') . ' <a href="' . site_url('my-page-2', 'login') . '">' . __('Log in') . '</a></p>');
		login_footer();
		exit;
	}
