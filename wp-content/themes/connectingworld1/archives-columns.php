 <?php
  /*
  Template Name: archives columns
  */
 get_header(); ?>
...
<div class="span-24" id="contentwrap">
	<div class="span-13">
		...
		//query
		 query_posts("cat=1&posts_per_page=5&order=DESC&orderby=post_date&paged=$paged"); 		 
		 ?>
		 
 	  <h2>Welcome to the CW Columnists Archive &ndash; read and enjoy</h2>
