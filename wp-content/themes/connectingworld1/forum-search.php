<?php
  /*
  Template Name: Forum_phpbb2_search
  */
 get_header(); ?>
		...
		<div id="content" style="background-color:#FFF;">	
			...
			<div class="post" id="post-<?php the_ID(); ?>">
                ...
                <?php if ( function_exists('has_post_thumbnail') && has_post_thumbnail() ) { the_post_thumbnail(array(300,225), array('class' => 'alignleft post_thumbnail')); } ?>
					...
					<iframe src="<?php echo get_option('siteurl'); ?>/phpBB3/search.php" style="min-height:1200px; height:auto;" title="Forum" width="785"  align="middle"></iframe>
</div>
			</div>
            </div>
			<?php endwhile; endif; ?>
