...
<?php
	...
	<div class="simplemodal-login-credit"><a href="http://www.ericmmartin.com/projects/simplemodal-login/">%s</a></div>
		 ...
		 * into your function.
		 * @return string
		 * <p class="modal-register"><i>New User</i><a href="'.get_option('home').'"> Click here to Register now!</a><img src="'.get_bloginfo('template_directory'). '/images/free.gif" alt="free" /></p>
		 */
		function login_form() {
			$output = sprintf('
	<form name="loginform" id="loginform" action="%s" method="post">
		...
		<p>
			...
			<input type="password" name="pwd" class="user_pass input" value="" size="20" tabindex="20" /></label>
				...
				site_url('wp-login.php', 'login_post') . '?redirect_to=/',
