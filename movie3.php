...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="640" height="525" id="FlashID" title="Understand what CW is about">
  <param name="movie" value="<?php echo bloginfo('url')?>/wp-content/uploads/swfmedia/cw_engelska.swf" />
  ...
  <!--[if !IE]>-->
  <object type="application/x-shockwave-flash" data="<?php echo bloginfo('url')?>/wp-content/uploads/swfmedia/cw_engelska.swf" width="640" height="525">
    <!--<![endif]-->
    <param name="quality" value="high" />
    <param name="wmode" value="opaque" />
    <param name="swfversion" value="9.0.45.0" />
