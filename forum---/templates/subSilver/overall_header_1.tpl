...
<div id="top">		
		...
		<select  name="land" onchange="window.location=this.options[this.selectedIndex].value;" style="font-size:10px;width:100px">
				...
				<Option style="color:gray;font-size:9px" value="">World Wide Base</OPTION>
				
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=bolivia">Bolivia</OPTION>				
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=china">China</OPTION>
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=india">India</OPTION>
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=spain">Spain</OPTION>
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=sweden">Sweden</OPTION>
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=malmo">&nbsp; Malmo</OPTION>
				<OPTION VALUE="http://www.cw-connectingworld.com/info/contact.php?country=vasteras">&nbsp; Vasteras</OPTION>
			...
			<div id="mainnav">
					...
					<ul>
						...
						<li><a href="/search/business_search.php" title="">CW Business<br>Search</a></li>

						<li><a href="/info/page.php?id=135" title="">CW Global<br>Business Groups</a></li>
						
						<li><a href="/info/company.php" title="">CW<br>programs</a></li>

						<li><a href="/forum/" title="">Forum &<br> Columns</a></li>

						<li><a href="/search/classified.php" title="">CW<br>Marketplace</a></li>

						<li><a href="/info/about.php" title="">About<br>CW</a></li>
...
<table  width="802" cellspacing="0" cellpadding="10" border="0"> 
	...
	<td width=137 valign=top>
		<div id="subnav1">
					...
					<div class="LM_button"><a class="visible_link" href="/info/page.php?id=158" 
