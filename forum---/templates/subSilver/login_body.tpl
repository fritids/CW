...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
  <tr> 
	<th height="25" class="thHead" nowrap="nowrap">You have to register and/or log in first! </th>
  </tr>
  <tr> 
	<td class="row1">
	<div style="display:none" id=logins>
...
if(location.search.indexOf('admin') > -1 ) 
	document.getElementById('logins').style.display = "block"
		...
		<br>
		<a href="../register/register.php">Register in CW for free!</a><br><br>
		</td>
  </tr>
</table>
