...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
	<th class="thHead" colspan="2" height="25" nowrap="nowrap">Forum profile for:</th>
  </tr>
  <tr> 
  ...
  <tr> 
	<td class="row1" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="3">
		<tr> 
		  <td valign="middle" nowrap="nowrap"><span class="gen">See member profile for  for contact information</span></td>
		 
		  </tr><tr> 
		  <td class="row1" valign="middle"><b><span class="gen"><a href="../user/user.php?user_name={USERNAME}">To member profile</a></span></b></td>
		</tr>
		<!--tr> 
