...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr _style="display:none"> 
		<th class="thHead" colspan="2" height="25" valign="middle">Change your forum settings</th>
	</tr>
	...
	<tr style="display:none"> 
	  <td cstyle="display:none"lass="row1"><span class="gen">{L_ICQ_NUMBER}:</span></td>
	  <td class="row2"> 
