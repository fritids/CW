...
class wpdb {
	 ...
	 * @var array
	 */
var $tables = array( 'posts', 'comments', 'links', 'options', 'postmeta', 'terms', 'term_taxonomy', 'term_relationships', 'commentmeta', 'country' ,'user', 'unspsc', 'industry', 'nbr_employe', 'annual_sales' , 'provid_service', 'company','business_type', 'unspsc_company', 'region', 'regions', 'regtype','spokenlanguage','message','message_saved','message_sent','profile_visitor','enk','classified_cat','classified','paynova_conf','favorites','easymail_recipients','message','message_saved','message_sent', 'product','ft_lua_userlogins');
